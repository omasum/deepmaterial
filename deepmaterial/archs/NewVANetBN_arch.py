...
class NewVANetBN(nn.Module):
	def __init__(self,input_channel,output_channel, rough_channel):
		...
		# self.instance_normal1 = nn.BatchNorm2d(64,affine=True)
		self.instance_normal2 = nn.BatchNorm2d(128,affine=True)
		self.instance_normal3 = nn.BatchNorm2d(256,affine=True)
		self.instance_normal4 = nn.BatchNorm2d(512,affine=True)
		self.instance_normal5 = nn.BatchNorm2d(512,affine=True)
		self.instance_normal6 = nn.BatchNorm2d(512,affine=True)
		self.instance_normal7 = nn.BatchNorm2d(512,affine=True)

		self.instance_normal_de_1_diff = nn.BatchNorm2d(512,affine=True)
		self.instance_normal_de_2_diff = nn.BatchNorm2d(512,affine=True)
		self.instance_normal_de_3_diff = nn.BatchNorm2d(512,affine=True)
		self.instance_normal_de_4_diff = nn.BatchNorm2d(512,affine=True)
		self.instance_normal_de_5_diff = nn.BatchNorm2d(256,affine=True)
		self.instance_normal_de_6_diff = nn.BatchNorm2d(128,affine=True)
		self.instance_normal_de_7_diff = nn.BatchNorm2d(64,affine=True)

		self.instance_normal_de_1_normal = nn.BatchNorm2d(512,affine=True)
		self.instance_normal_de_2_normal = nn.BatchNorm2d(512,affine=True)
		self.instance_normal_de_3_normal = nn.BatchNorm2d(512,affine=True)
		self.instance_normal_de_4_normal = nn.BatchNorm2d(512,affine=True)
		self.instance_normal_de_5_normal = nn.BatchNorm2d(256,affine=True)
		self.instance_normal_de_6_normal = nn.BatchNorm2d(128,affine=True)
		self.instance_normal_de_7_normal = nn.BatchNorm2d(64,affine=True)

		self.instance_normal_de_1_rough = nn.BatchNorm2d(512,affine=True)
		self.instance_normal_de_2_rough = nn.BatchNorm2d(512,affine=True)
		self.instance_normal_de_3_rough = nn.BatchNorm2d(512,affine=True)
		self.instance_normal_de_4_rough = nn.BatchNorm2d(512,affine=True)
		self.instance_normal_de_5_rough = nn.BatchNorm2d(256,affine=True)
		self.instance_normal_de_6_rough = nn.BatchNorm2d(128,affine=True)
		self.instance_normal_de_7_rough = nn.BatchNorm2d(64,affine=True)

		self.instance_normal_de_1_spec = nn.BatchNorm2d(512,affine=True)
		self.instance_normal_de_2_spec = nn.BatchNorm2d(512,affine=True)
		self.instance_normal_de_3_spec = nn.BatchNorm2d(512,affine=True)
		self.instance_normal_de_4_spec = nn.BatchNorm2d(512,affine=True)
		self.instance_normal_de_5_spec = nn.BatchNorm2d(256,affine=True)
		self.instance_normal_de_6_spec = nn.BatchNorm2d(128,affine=True)
		self.instance_normal_de_7_spec = nn.BatchNorm2d(64,affine=True)

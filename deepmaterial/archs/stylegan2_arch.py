...
from deepmaterial.ops.fused_act import FusedLeakyReLU, fused_leaky_relu
from deepmaterial.ops.upfirdn2d import upfirdn2d
...
class ToRGB(nn.Module):
    ...
    def __init__(self, in_channels, num_style_feat, brdf=False, upsample=True, resample_kernel=(1, 3, 3, 1)):
        ...
        if brdf:
            ...
            out_channel = 3
        self.modulated_conv = ModulatedConv2d(
            in_channels, out_channel, kernel_size=1, num_style_feat=num_style_feat, demodulate=False, sample_mode=None)
...
class StyleGAN2Generator(nn.Module):
    ...
    def __init__(self,
        ...
        self.style_conv1 = StyleConv(
            ...
            sample_mode=None,
            resample_kernel=resample_kernel)
        self.to_rgb1 = ToRGB(channels['4'], num_style_feat, brdf=brdf, upsample=False, resample_kernel=resample_kernel)
        ...
        for i in range(3, self.log_size + 1):
            ...
            self.style_convs.append(
                StyleConv(
                    ...
                    sample_mode=None,
                    resample_kernel=resample_kernel))
            self.to_rgbs.append(ToRGB(out_channels, num_style_feat, brdf = self.brdf, upsample=True, resample_kernel=resample_kernel))
...
class StyleGAN2Discriminator(nn.Module):
    ...
    def __init__(self, out_size, channel_multiplier=2, outC=3, resample_kernel=(1, 3, 3, 1), stddev_group=4, narrow=1):
        ...
        conv_body = [ConvLayer(outC, channels[f'{out_size}'], 1, bias=True, activate=True)]

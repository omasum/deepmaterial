...
from deepmaterial.data.brdf_dataset import svbrdfDataset
...
# pipeline
# initializing classification and normal
# assembling all measurements per class
# predicting brdf per class
# evaluting errors and regularization and optimizing
# adding a material class and initializing

def opt_pipeline(root_path):
    ...
    for test_loader in test_loaders:
        ...
        for idx, val_data in enumerate(test_loader):
            img, svbrdf = val_data['img'], val_data['svbrdf']
            model.set_image(img, svbrdf)

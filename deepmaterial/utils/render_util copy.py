...
lightDistance = 2.14
viewDistance = 4.0  # 54.201 degrees FOV ; area_lighting height
...
class Camera:
    ...
    def fixedView(self):
        currentViewPos = torch.from_numpy(np.array([1.0, 0.0, viewDistance])).view(1, 3)
        # [1,1,3]
...
if __name__ == "__main__":
    ...
    import torchvision
    if True:
        path = '/home/sda/svBRDFs/testBlended/0000005;PolishedMarbleFloor_01Xmetal_bumpy_squares;0Xdefault.png' # [256*5,256]indrs

...
def main(mode='folder'):
    ...
    opt['phase'] = 'test'
    opt['name'] = 'brdf'
    opt['type'] = 'normalDataset'
    # opt['dataroot_train'] = 'D:/Datasets/svBRDFs/testBlended'
    # opt['dataroot_test'] = 'D:/Datasets/svBRDFs/testBlended'
    opt['dataroot_train'] = '/home/sda/svBRDFs/testBlended'
    opt['dataroot_test'] = '/home/sda/svBRDFs/testBlended'
    opt['fixed_input'] = True
    ...
    for i, data in enumerate(data_loader):
        ...
        svbrdfs = dataset.svBRDF.brdf2uint8(svbrdfs, n_xy=False, gamma_correct='ds')
